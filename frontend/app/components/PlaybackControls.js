  ...
  return (
    <div className="flex items-center justify-center gap-6 md:gap-8">
      ...
      <button
        ...
        className="w-12 h-12 md:w-14 md:h-14 rounded-full bg-white/20 hover:bg-white/30 active:bg-white/40 flex items-center justify-center transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-white/50"
      ...
      <button
        ...
        className="w-16 h-16 md:w-20 md:h-20 rounded-full bg-teal-primary hover:bg-teal-primary/90 active:bg-teal-primary/80 flex items-center justify-center transition-colors duration-150 shadow-lg focus:outline-none focus:ring-2 focus:ring-teal-primary/50 focus:ring-offset-2 focus:ring-offset-transparent"
